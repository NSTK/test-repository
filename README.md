...
## Автоматическое версионирование с semantic-release

В проекте настроено автоматическое семантическое версионирование с помощью semantic-release.

- Создание релизов: Релизы автоматически создаются при мерже изменений в ветку main.
- Типы изменений:
  - feat: Новая функциональность (увеличение MINOR версии).
  - fix: Исправление ошибок (увеличение PATCH версии).
  - BREAKING CHANGE: Ломающие изменения (увеличение MAJOR версии).
- Рабочий процесс:
  1. Создайте ветку.
  2. Используйте сообщения коммитов согласно Conventional Commits.
  3. Откройте Pull Request и вмёржьте изменения в main.

Подробнее о настройке см. файл .releaserc и workflow release.yml.